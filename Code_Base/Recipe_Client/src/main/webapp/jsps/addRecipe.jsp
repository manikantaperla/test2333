		...
		<div class="col-md-offset-2 col-md-7">
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form:form action="addRecpValues.htm" cssClass="form-horizontal"
						method="post" commandName="recipes">

						<div class="form-group">
							<label for="recpName" class="col-md-3 control-label">Recipe
								Name</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								...
								Yes
								<form:radiobutton path="recpInd" value="Yes" />
								No
								<form:radiobutton path="recpInd" checked="checked" value="No" />
							</div>
						</div>
